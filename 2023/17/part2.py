...
while True:
    ...
    if minx == field.shape[0] - 1 and miny == field.shape[1] - 1 and minstreak >= 4:
        print(minDist)
        break
    
    if mindir == 'R':
        if miny + 1 < field.shape[1] and minstreak < 10:
    ...
    if mindir == 'D':
        if minx + 1 < field.shape[0] and minstreak < 10:
    ...
    if mindir != 'R' and mindir != 'L' and minstreak >= 4:
    ...
    if mindir != 'L' and mindir != 'R' and minstreak >= 4:
        if miny - 1 >= 0:
    ...
    if mindir != 'D' and mindir != 'U':
        if minx + 1 < field.shape[0] and minstreak >= 4:
    ...
    if mindir != 'U' and mindir != 'D' and minstreak >= 4:
        if minx - 1 >= 0:
